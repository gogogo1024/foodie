...
public class IdWorker {
    ...
    // 初始计时时间
    protected long epoch = 1687873735070L; //2023/06/27 21:48:55
    protected long workerIdBits = 10L;
    protected long maxWorkerId = ~(-1L << workerIdBits); //2^10-1  1023
    ...
    protected long sequenceMask = ~(-1L << sequenceBits); //2^11-1 2047
